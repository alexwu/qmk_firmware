...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_GRV,  KC_LALT, EISU,   KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KANA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_LEFT,   KC_DOWN, KC_UP,  KC_RIGHT, KC_RBRC, KC_BSLS, \
...
void delete_previous_word(bool pressed) {
  if (pressed) {
